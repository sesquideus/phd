    ...
    \section{Data}{
        \subsection{Data}
            \frejm{Acquisition}{
                ...
                \begin{itemize}
                    \item UFO by \emph{SonotaCo}
                    \item AMOS by \emph{Kvant}
                    \begin{itemize}
            ...
            \frejm{Retrieval}{
                ...
                \begin{itemize}
                    ...
                    \item sent over HTTP as a POST request
                    \pause
        ...
        \subsection{Database}
            ...
            \frejm{Models}{
                ...
                \begin{itemize}
                    ...
                    \item \code{VideoFrame}... not yet, maybe later
                \end{itemize}
            }
            ...
            \frejm{Model \code{Sighting} -- miscellanea}{
                \begin{itemize}

...
\title{Numerical Simulation of Meteors as a Means of Debiasing AMOS Data}
\author{\small Martin Baláž \hspace{1cm} Juraj Tóth, PhD. \hspace{1cm} Robert Jedicke, PhD. \hspace{1cm} Peter Vereš, PhD.}
		...
		\section{Simulation}
			\subsection{Simulation}
				...
				\frejm{Simulation of flight}{
					modified Runge--Kutta integrator (RK4)
					\begin{itemize}
				...
				\frejm{Virtual observations}{
					...
					\begin{itemize}
						...
						\item only the brightest frame is analyzed
					\end{itemize}           
				}
    ...
    \section{Asmodeus}    
		\subsection{Asmodeus}
			\frejm{What is it}{
				...
				\begin{itemize}
					\item a suite of five \emph{Python} scripts
			...
			\frejm{Summary}{
				...
				\begin{itemize}
					...
					\begin{itemize}
						...
						\item and the results are aesthetically pleasing
				...
				\begin{itemize}
					...
					\begin{itemize}
						...
						\item a good fit was found
						\pause
						\item mass index seems to be much higher than known values
						\item a much larger observational dataset is needed
					\end{itemize}
				\end{itemize}
			}

...
\begin{document}
    ...
    \section{Mass}
        \frejm{Parameters}{
            \begin{itemize}
                ...
                \end{itemize}
                \pause
                \item mass from \SI{1}{\micro\gram} to \SI{1}{\kilo\gram}
    ...
    \section{Ablation}
        \frejm{Heat of ablation}{
            \begin{itemize}
                \item $Q$ varied between \SIrange[per-mode = symbol]{1e3}{1e9}{\joule\per\kilo\gram}
                \pause

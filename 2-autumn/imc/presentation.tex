...
\begin{document}
    ...
    \section{}
        \frejm{Deficiencies of the }{
        }

        \frejm{Comparison with real meteors}{
        }


        \fspicture{time-absMag-mjd.png}
        \fspicture{time-elevation-mjd.png}
        \fspicture{time-logMass-mjd.png}
							
    \section{Conclusion}
        \frejm{Validation}{
            Revise High velocity meteor ablation

...
\begin{document}
    ...
    \section{Overview}
        \frejm{What do we have?}{
            ...
            \pause
            \begin{itemize}
                \item let's take it beyond pure statistics
            \end{itemize}
    ...
    \section{Simulation}
        ...
        \frejm{Simulation of flight}{
            ...
            \begin{itemize}
                \item full 3D simulation on spherical Earth
    ...
    \section{Prerequisites}
        ...
        \frejm{What is it good for?}{
            \begin{itemize}
                \item predict parameters of \emph{any} incoming particle
                \item improve ablation and flight models
                \item try to find anything interesting in the data
            \end{itemize}
        }
    ...
    \section{Conclusion}
        \frejm{Validation}{
            \begin{itemize}
                \item try to simulate \emph{individual meteors}

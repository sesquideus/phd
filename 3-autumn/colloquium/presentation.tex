...
\begin{document}
    ...
    \section{2020 Perseids}
        ...
        \frejm{Night 1 (2020--08--11/12)}{
            \begin{itemize}
                \item location: \emph{Grúň}, Hažín, MI, \SI{134}{\metre}
                \item light pollution index \num{0.33} (Bortle 3)
            \end{itemize}
        }

        \frejm{Night 2 (2020--08--12/13)}{
            \begin{itemize}
        ...
        \frejm{Meteors}{
            \begin{itemize}
                ...
                \item summary
                    \begin{itemize}
                        \item 341 meteors by me
                        \item 235 meteors by other people
                        \item total \emph{576} in 7 hours
                    \end{itemize}
            \end{itemize}
        }
    ...
    \section{Kvet ústavy 1}
        ...
        \frejm{Results}{
            ...and even more beautiful objects
            \begin{itemize}
                \item 
            \end{itemize}
        }
    ...
    \section{Summary}
        \frejm{References}{
            \begin{itemize}
                ...
                \item photos of KVÚ-1 by \textbf{Michal Valíček}
            \end{itemize}
        }
\end{document}

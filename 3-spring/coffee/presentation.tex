...
\title{???}
\subtitle{Traja pátrači: záhada koeficientu Γ}
    ...
    \section{Overview}
        ...
        \frejm{Drag crisis / Eiffel paradox}{
            \begin{itemize}
                ...
                \item Prečo padajúci meteorit v exponenciálne hustnúcej atmosfére zrýchľuje?
            \end{itemize}
        }
            ...
            \begin{itemize}
                ...
                \item dva ďalšie efekty
                    \begin{itemize}
                        ...
                        \item vysoko nadzvuková rýchlosť a rázové vlny -- 
                    \end{itemize}
            \end{itemize}
        }
        ...
        \frejm{Machovo číslo}{
            ...
            \begin{itemize}
                ...
                \item model iba s $\mathrm{Re}$ sa nedá použiť
            \end{itemize}

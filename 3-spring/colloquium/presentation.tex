            ...
            \begin{itemize}
                \item data acquisition
                    \begin{itemize}
                        ...
                        \item \textcolor{gray}{optional spectral camera}
                    \end{itemize}
                \pause
                \item preprocessing
                    \begin{itemize}
                    ...
                    \begin{itemize}
                        ...
                        \item \code{AMOS server}
                            \begin{itemize}
                                ...
                                \item data analysis
                            \end{itemize}
                        \item no Synology, but \emph{RAID} on board
                    \end{itemize}
                \end{column}
            \end{columns}
        }
        ...
        \frejm{Retrieval}{
            \begin{columns}
                ...
                \begin{column}{0.49\textwidth}
                    \emph{New}:
                    \begin{itemize}
                        \item AMOS controller scans the output directory
                        \item files moved to correct subdirectory (\code{yyyy/mm/dd})
                        \item sent over HTTP in a POST request (except AVI)
                    \end{itemize}
                \end{column}
            \end{columns}
        }
...
854, "2021-04-16 21:58:35", -2.2
        ...
        \fspdfpage{pictures/schema.pdf}{2}

...
\NewDocumentCommand{\fspdfpage}{m m O{W} O{black}}{
    {
        \setbeamertemplate{navigation symbols}{}
        ...
        \begin{frame}[plain]
            \begin{tikzpicture}[remember picture, overlay]
                \node[at=(current page.center)] {
                    \ifstrequal{H}{#3}{
                        \includegraphics[page=#2, height=\paperheight]{#1}%
                    }{%
                        \includegraphics[page=#2, width=\paperwidth]{#1}%
                    }
                };
            \end{tikzpicture}
        \end{frame}
...
\AtBeginSection[]{
    \subsection{\texorpdfstring{\insertsection}{\thesection}}
    \begin{frame}
        \vfill
        \centering

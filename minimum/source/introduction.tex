...
The research of interplanetary matter is ... \todo{finish the sentences}
...
\section{Asteroids, comets and meteoroids} \label{ia}
    ...
    \subsection{Meteoroids} \label{iam}
        ...
        or finally artificial meteoroids, launched with the expressed purpose of creating meteors \citep{japončíci?} \todo{fix}.
    ...
    \subsection{Stations} \label{iAs}
        ...
        \begin{description}[leftmargin = 25mm]
            ...
            \item[SENEC]    Senec Observatory\\
                            since ???, coordinates \ang{48.2203}~N, \ang{17.3950}~E, \SI{137}{\metre} \todo{fix date}
        \end{description}
        ...
        \begin{description}[leftmargin = 25mm]
            \item[HK]       Haleakalā High Altitude Observatory Site, Kula, Maui, Hawaii, USA\\
                            since ???, coordinates \ang{20.7075}~N, \ang{156.2560}~W, \SI{3041}{\metre} \todo{fix date}
            \item[MK]       Mauna Kea Observatories, Hawai`i County, Hawaii, USA\\
                            since ???, coordinates \ang{19.8228}~N, \ang{155.4697}~W, \SI{4203}{\metre} \todo{fix date}
        \end{description}

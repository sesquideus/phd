...
\section{Observational model} \label{ms}
    ...
    \eqn{eq:ms-dist}{
        (\delta_\mathrm{R}, \alpha_\mathrm{R}, t, v_\infty, m)
    }
...
\section{Orbital model} \label{mo}
    ...
    \subsection{Choice of coordinate space} \label{moc}
        ...
        \eqn{eq:po-elem}{
            M_\mathrm{oe}(a, e, i, \omega, \Omega, T, t).
        }
        ...
        \subsubsection{Optimizations} \label{moco}
            ...
            \eqn{eq:moco-psxyz}{
                \mathcal{M}_c(x, y, z, v_x, v_y, v_z, t, \log m),
            }
            or in terms of orbital elements,
            \eqn{eq:moco-psorb}{
                \mathcal{M}_o(1/a, e, i, \omega, \Omega, T, t, \log m).
            }

...
meteor-observing networks whiciih cover the sky practically continuously, at least as long as the weather is favourable.
The sky maps obtained from this model are can be used to predict the activity of meteor showers and of the sporadic background.
...
In both models, meteoroids and meteors are not treated as discrete entities,
but rather as random samples from some hidden underlying distribution.
...
\section{Observational model} \label{ms}
    ...
    This model can be \emph{complete}, in the sense that it is possible -- at least
    ...
    In reality there might be discrepancies caused by selection bias, lower coverage of the southern hemisphere
    or difficulty in detecting daytime meteor showers.
    ...
    \subsection{Physical quantities in the model} \label{msp}
        ...
        \subsubsection{Time} \label{mspt}
            ...
            Precise timekeeping is thus not very important in the model.
            ...
            Differences on the order of tens of minutes could be visible with very narrow filaments though.
        ...
        \subsubsection{Position} \label{mspp}
            ...
            it is not very useful in the observational model.
            ...
            while its adherence to the stream would not be changed.
...
\section{Orbital model} \label{mo}
    ...
    and can only be investigated with in-situ observations.
    In this thesis we will not analyze them any further.

    A less fundamental, but still important difficulty lies in the precision of these measurements.
    ...
    One very pronounced effect of this is the vastly overestimated number of objects
    ...
    \subsection{Choice of coordinate space} \label{moc}
        ...
        \eqn{eq:po-rv}{
            \mathcal{M}_\mathrm{rv}(t, \vec{r}, \vec{v}).
        }
%        where
%        \begin{description}
%            \item[$\vec{r}$]
...
%        \end{description}
        ...
        \eqn{eq:po-elem}{
            \mathcal{M}_\mathrm{oe}(t, a, e, i, \omega, \Omega, \phi).
        }
        ...
        \subsubsection{Optimizations} \label{moco}
            ...
            This is very similar to how magnitudes are reported instead of flux densities, as
            ...
            \eqn{eq:moco-psxyz}{
                \mathcal{M}_c(t, \vec{r}, \vec{v}, \log \mu) \equiv \mathcal{M}_c(t, x, y, z, v_x, v_y, v_z, \log \mu),
            }
            or in terms of orbital elements,
            \eqn{eq:moco-psorb}{
                \mathcal{M}_o(t, 1/a, e, i, \omega, \Omega, T, \log \mu).
            }

            Further optimizations in this spirit may be added where deemed beneficial.
    ...
    \subsection{Physical quantities and properties} \label{mop}
        ...
        \subsubsection{Fluxes and densities} \label{mopf}
            ...
            \eqn{eq:mopf-spatial}{
                \varrho(t, \vec{r}) = \Int[\mu_0][\infty]{
                    \Int[\Real^3][]{\mathcal{M}(t, \vec{r}, \vec{v}, \mu)}{\vec{v}}
                }{\mu}.
            }
            ...
            \eqn{eq:mopf-flux}{
                \Phi(t, \vec{r}, \uvec{n}) = \Int[\mu_0][\infty]{
                    \Int[\Real^3]{
                        \mathcal{M}(t, \vec{r}, \vec{v}, \mu) \Abs{\vec{v} \cdot \uvec{n}}
                    }{\vec{v}}
                }{\mu}.
            }
            ...
            \Cref{eq:mopf-flux} becomes
            \eqn{eq:mopf-mflux}{
                F(t, \vec{r}) = \Int[\mu_0][\infty]{
                    \Int[\Real^3][]{\mu \mathcal{M}(t, \vec{r}, \vec{v}, \mu)}{\vec{v}}
                }{\mu}.
            }
...
%        with precision only limited by our knowledge of initial positions and velocities of the bodies.
        ...
        By comparing the orbital speed to the diameter of the Earth we can see that the Earth moves

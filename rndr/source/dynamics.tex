    ...
    \subsection{Viscosity} \label{fdv}
        ...
        \subsubsection{Formulae} \label{fdvf}
            ...
            \begin{example}[Homosphere and heterosphere]
                ...
                \fig{msis-species.pdf}{0.8\textwidth}{fig:fdvf-species}{
            ...
            Since temperatures encountered in the atmosphere fall within this range most of the time
            and the model is fairly simple, we shall use it in all our calculations.
    ...
    \subsection{Analysed models} \label{fdm}
        ...
        \subsubsection{Morrison model} \label{fdmM}
            ...
            \begin{example}[A note on the term ``free fall'']
                The terms here are a bit confusing. We distinguish true \emph{free fall} as

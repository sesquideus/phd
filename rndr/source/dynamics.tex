...
%                well even when all other forces are neglected.
    ...
    \subsection{Drag force} \label{dfd}
        ...
        \subsubsection{Loth model} \label{ddL}
            ...
            \eqn{eq:ddL-CdKnRe}{
                C_\mathrm{d, Kn, Re} =
                \frac{24}{\mathrm{Re}_\infty} \left(1 + \num{0.15} \mathrm{Re}_\infty^{\num{0.687}}\right) f_\mathrm{Kn}
            }
            ...
            \eqn{eq:ddL-CdfmRe}{
                ...
                \frac{
                    ...
                    1 + \left(\frac{C_\mathrm{d,fm}^\prime}{\num{1.63}} - 1\right)\sqrt{\frac{\mathrm{Re}_\infty}{45}}
                }
            }
            and the final expression for $C_d$ is
            \eqn{eq:ddL-Cd}{
                C_d =
                \begin{dcases}
                    \frac{
                        C_\mathrm{d, Kn, Re} + M_\infty^4 C_\mathrm{d, fm, Re}
                    }{
                        1 + M_\infty^4
                    } & \mathrm{Re}_\infty \leq 45; \\
                    \frac{24}{\mathrm{Re}_\infty} \left(1 + \num{0.15} \mathrm{Re}_\infty^{\num{0.687}}\right) H_M
                        + \frac{\num{0.42} C_M}{1 + \frac{\num{42500} G_M}{\mathrm{Re}_\infty^{\num{1.16}}}}
                        & \mathrm{Re}_\infty > 45.
                \end{dcases}
            }

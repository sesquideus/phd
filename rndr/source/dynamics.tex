...
\section{Drag force} \label{fd}
    ...
    \subsection{Analysed drag models} \label{fdm}
        ...
        \subsubsection{Morrison model} \label{fdmM}
            ...
            \fig{drag-crisis.pdf}{100mm}{ddm-drag-crisis}{%
                ...
                occurs at much a lower Reynolds number, about \num{8e4}. Although typical meteoroids cannot
                be reasonably approximated by smooth spheres, 
                }

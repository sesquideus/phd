...
\section{Models of the Earth}
    ...
    \subsection{Locally flat Earth} \label{mmf}
     ...
     \begin{description}
         \item[northing] the distance in the direction of local true north;
         \item[easting] the distance in the direction of local true east;
         \item[altitude] the distance in the direction straight up (away from the centre of the Earth).
     \end{description}

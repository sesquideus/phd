...
\section{Models of the Earth}
    ...
    \subsection{Spherical Earth} \label{mms}
        ...
        $(r, \theta, \phi)$, where
        \begin{description}
            \item[$r$] is the \emph{radial distance} from the origin of the coordinate system,
    ...
    \subsection{Oblate spheroid} \label{mmw}
        ...
        inside the Earth, can also be safely ignored in our use case.
    ...
    \subsection{Comparison} \label{mmc}
        ...
        but are on the order of hundreds of kilometres. This keeps relative errors considerably lower.
